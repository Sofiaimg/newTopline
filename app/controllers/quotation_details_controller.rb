class QuotationDetailsController < ApplicationController
  ...
  private
    ...
    def quotation_detail_params
      params.require(:quotation_detail).permit(:quotation_id, :brand_id, :product_id, :style, :color_id, :quantity, :size_id, :ratio, :delivery_date, :target_price, :final_price, :otherdetails, :total, :status,
