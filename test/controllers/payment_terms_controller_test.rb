...
class PaymentTermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_term" do
    assert_difference('PaymentTerm.count') do
      post payment_terms_url, params: { payment_term: { clause: @payment_term.clause, conditions: @payment_term.conditions } }
    end
  ...
  test "should update payment_term" do
    patch payment_term_url(@payment_term), params: { payment_term: { clause: @payment_term.clause, conditions: @payment_term.conditions } }
