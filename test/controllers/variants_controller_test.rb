...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post variants_url, params: { variant: { quantity: @variant.quantity, quotation_detail_id: @variant.quotation_detail_id, ratio: @variant.ratio, size_id: @variant.size_id } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { quantity: @variant.quantity, quotation_detail_id: @variant.quotation_detail_id, ratio: @variant.ratio, size_id: @variant.size_id } }
