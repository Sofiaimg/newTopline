...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { address: @seller.address, country: @seller.country, email: @seller.email, name: @seller.name, phone: @seller.phone } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { address: @seller.address, country: @seller.country, email: @seller.email, name: @seller.name, phone: @seller.phone } }
